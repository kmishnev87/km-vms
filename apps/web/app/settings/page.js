...
} from "../../components/SettingsMaintenanceSurface";
import { useSettingsMaintenanceController } from "../../lib/settingsMaintenanceController";
...
const TEXT = {
  ru: {
    ...
    updateApplyProgressIndeterminate: "Выполняется…",
...
const ZH_TEXT_OVERRIDES = {
  ...
  updateApplyProgressIndeterminate: "正在执行…",
...
export default function SettingsPage() {
  ...
  const maintenanceController = useSettingsMaintenanceController({
    ...
    <Layout>
      <div className="settingsPage">
            ...
            <div className="settingsReferenceLayout">
              <section className="settingsPanel">
                ...
                <div className="settingsRow">
                  ...
                  <div className="settingsRowControl settingsRowControlMeta">
                    <button
                      ref={maintenanceController.maintenanceTriggerRef}
                      className="button secondary small appIllustratedAction settingsUsersAddButton"
                      onClick={maintenanceController.openMaintenanceModal}
        ...
        <SettingsMaintenanceModal
          ...
          onOpenDiagnosticChoice={() => setDiagnosticChoiceOpen(true)}
        />
