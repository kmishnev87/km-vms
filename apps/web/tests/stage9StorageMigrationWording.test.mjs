...
const stage9RenderedKeys = [
  "archiveMigration",
  "migrationNeedsTargetStatus",
  "migrationChooseTargetStatus",
  "migrationPlanReadyStatus",
  "migrationNeedsTarget",
  "migrationChooseTargetFirst",
  "migrationPlanReady",
  "migrationScenarioText",
  "move",
  "willStay",
  "blockers",
  "applyState",
  "refreshMigrationPreview",
  "migrationPreviewShort",
  "migrationSteps",
  "migrationTarget",
  "migrationAddTargetFirst",
  "applyMigration",
  "applyMigrationShort",
  "applying",
  "applyConfirm",
