...
ENDPOINT_PERMISSIONS: tuple[EndpointPermission, ...] = (
    ...
    EndpointPermission("system", "POST", "/system/update/apply/submission-ticket", PERMISSION_MANAGE_SETTINGS, "require_permission", "Issues one short-lived actor/target-bound signed Apply submission proof; no update admission or helper execution."),
    ...
    EndpointPermission("system", "GET", "/system/update/apply/reconciliation/{submission_id}", PERMISSION_MANAGE_SETTINGS, "require_permission", "Read-only exact retained-submission reconciliation using the signed proof header; no admission, audit or helper mutation."),
