...
def _public_error_for_category(category: str) -> dict[str, str]:
    ...
    actions = {
        ...
        "slot_adoption_conflict": "Verify the installed source and runtime state before retrying.",
        "source_acquisition_failed": "Verify access to the trusted release source, then retry.",
        "source_temporarily_unavailable": "Wait briefly, then run the update again.",
